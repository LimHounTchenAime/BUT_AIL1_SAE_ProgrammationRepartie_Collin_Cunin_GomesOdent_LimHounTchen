...
async function loadMap()
{
    try {
        const results = await Promise.allSettled([
            ...
            fetcher("https://localhost:8000/data")
        ]);
        ...
        let restaurants = loadChecker(results[4], "Impossible de récupérer les informations des restaurants");

        processMap(locationData, stationStatusData, stationInformationData, trafficProblemsData, restaurants);
 ...
 */
function processMap(locationData, stationStatusData, stationInformationData, trafficProblemsData, restaurants)
{
    // --- Display the map ---
